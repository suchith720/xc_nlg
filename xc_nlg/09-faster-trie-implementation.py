# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/09-anshul-trie-implementation-Copy1.ipynb.

# %% auto 0
__all__ = ['dump_dir', 'fname', 'mname', 'model', 'args', 'metric', 'learn']

# %% ../nbs/09-anshul-trie-implementation-Copy1.ipynb 2
...
# %% ../nbs/09-anshul-trie-implementation-Copy1.ipynb 3
os.environ['WANDB_MODE'] = 'disabled'

# %% ../nbs/09-anshul-trie-implementation-Copy1.ipynb 4
dump_dir = '/scratch/scai/phd/aiz218323/Projects/xc_nlg/outputs/05-metadata-augmented-input-and-trie-for-distilbert/'

# %% ../nbs/09-anshul-trie-implementation-Copy1.ipynb 5
...
# %% ../nbs/09-anshul-trie-implementation-Copy1.ipynb 9
...
# %% ../nbs/09-anshul-trie-implementation-Copy1.ipynb 10
...
# %% ../nbs/09-anshul-trie-implementation-Copy1.ipynb 11
...
# %% ../nbs/09-anshul-trie-implementation-Copy1.ipynb 12
learn = XCLearner(
    model=model, 
    args=args,
