...
# %% ../nbs/47-encoder-parallel-radga-for-wikiseealso.ipynb 15
test_dset = block.test.dset.sample(n=2000, seed=50)
metric = PrecRecl(block.n_lbl, test_dset.data.data_lbl_filterer, prop=block.train.dset.data.data_lbl,
                  pk=10, rk=200, rep_pk=[1, 3, 5, 10], rep_rk=[10, 100, 200])

# %% ../nbs/47-encoder-parallel-radga-for-wikiseealso.ipynb 16
...
# %% ../nbs/47-encoder-parallel-radga-for-wikiseealso.ipynb 18
trie = XCTrie.from_block(block)

# %% ../nbs/47-encoder-parallel-radga-for-wikiseealso.ipynb 19
learn = XCLearner(
    model=model, 
    args=args,
    trie=trie,
...
# %% ../nbs/47-encoder-parallel-radga-for-wikiseealso.ipynb 23
