# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/45-1-encoder-parallel-ramen-clover-for-wikiseealso.ipynb.

# %% auto 0
__all__ = ['data_dir', 'pkl_file', 'args', 'output_dir', 'mname', 'bsz', 'model', 'trie', 'train_dset', 'metric', 'learn',
           'pred_dir', 'test_dset']

# %% ../nbs/45-1-encoder-parallel-ramen-clover-for-wikiseealso.ipynb 3
import os,torch, torch.multiprocessing as mp, pickle
from scipy import sparse
from xcai.basics import *
from xcai.models.PPP0XX import DBT017

# %% ../nbs/45-1-encoder-parallel-ramen-clover-for-wikiseealso.ipynb 5
os.environ['WANDB_MODE'] = 'disabled'

# %% ../nbs/45-1-encoder-parallel-ramen-clover-for-wikiseealso.ipynb 6
os.environ['CUDA_VISIBLE_DEVICES'] = '0,1'
os.environ['WANDB_PROJECT']='xc-nlg_22-oak-training-pipeline-with-multitriplet-loss-and-clustering'

# %% ../nbs/45-1-encoder-parallel-ramen-clover-for-wikiseealso.ipynb 8
...
# %% ../nbs/45-1-encoder-parallel-ramen-clover-for-wikiseealso.ipynb 9
args = XCLearningArguments(
    output_dir='/home/aiscuser/outputs/45-encoder-parallel-ramen-clover-for-wikiseealso-1-0',
...
# %% ../nbs/45-1-encoder-parallel-ramen-clover-for-wikiseealso.ipynb 10
output_dir = f"/home/aiscuser/scratch/Projects/xc_nlg/outputs/{os.path.basename(args.output_dir)}"
mname = f'{output_dir}/{os.path.basename(get_best_model(output_dir))}'

# %% ../nbs/45-1-encoder-parallel-ramen-clover-for-wikiseealso.ipynb 11
...
# %% ../nbs/45-1-encoder-parallel-ramen-clover-for-wikiseealso.ipynb 12
trie = XCTrie.from_block(block)

# %% ../nbs/45-1-encoder-parallel-ramen-clover-for-wikiseealso.ipynb 13
...
# %% ../nbs/45-1-encoder-parallel-ramen-clover-for-wikiseealso.ipynb 14
pred_dir = f'{mname}/predictions/'
os.makedirs(pred_dir, exist_ok=True)
with open(f'{pred_dir}/train_predictions.pkl', 'wb') as file: pickle.dump(train_pred, file)

# %% ../nbs/45-1-encoder-parallel-ramen-clover-for-wikiseealso.ipynb 16
...
# %% ../nbs/45-1-encoder-parallel-ramen-clover-for-wikiseealso.ipynb 17
pred_dir = f'{mname}/predictions/'
os.makedirs(pred_dir, exist_ok=True)
