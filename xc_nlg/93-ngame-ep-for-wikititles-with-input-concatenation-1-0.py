# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/93-ngame-ep-for-wikititles-with-input-concatenation.ipynb.

# %% auto 0
__all__ = ['pkl_dir', 'pkl_file', 'args', 'metric', 'bsz', 'model', 'learn']

# %% ../nbs/93-ngame-ep-for-wikititles-with-input-concatenation.ipynb 2
import os,torch, torch.multiprocessing as mp, pickle, numpy as np
from xcai.basics import *
from xcai.models.PPP0XX import DBT009,DBT011

# %% ../nbs/93-ngame-ep-for-wikititles-with-input-concatenation.ipynb 4
os.environ['CUDA_VISIBLE_DEVICES'] = '0,1'
os.environ['WANDB_PROJECT']='xc-nlg_93-ngame-ep-for-wikititles'

# %% ../nbs/93-ngame-ep-for-wikititles-with-input-concatenation.ipynb 19
pkl_dir = '/home/scai/phd/aiz218323/scratch/datasets'
pkl_file = f'{pkl_dir}/processed/wikititles_data-metas_distilbert-base-uncased_rm_ngame-hlk-sal-128.pkl'
with open(pkl_file, 'rb') as file: block = pickle.load(file)

# %% ../nbs/93-ngame-ep-for-wikititles-with-input-concatenation.ipynb 25
...
# %% ../nbs/93-ngame-ep-for-wikititles-with-input-concatenation.ipynb 26
...
# %% ../nbs/93-ngame-ep-for-wikititles-with-input-concatenation.ipynb 31
...
# %% ../nbs/93-ngame-ep-for-wikititles-with-input-concatenation.ipynb 32
metric = PrecRecl(block.n_lbl, block.test.data_lbl_filterer, prop=block.train.dset.data.data_lbl,
                  pk=10, rk=200, rep_pk=[1, 3, 5, 10], rep_rk=[10, 100, 200])

# %% ../nbs/93-ngame-ep-for-wikititles-with-input-concatenation.ipynb 33
...
# %% ../nbs/93-ngame-ep-for-wikititles-with-input-concatenation.ipynb 34
learn = XCLearner(
    model=model, 
    args=args,
...
# %% ../nbs/93-ngame-ep-for-wikititles-with-input-concatenation.ipynb 36
