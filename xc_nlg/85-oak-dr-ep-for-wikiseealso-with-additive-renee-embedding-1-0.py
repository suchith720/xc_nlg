# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/85-oak-dr-ep-for-wikiseealso-with-additive-renee-embedding.ipynb.

# %% auto 0
__all__ = ['pkl_dir', 'pkl_file', 'data_meta', 'args', 'metric', 'bsz', 'model', 'learn']

# %% ../nbs/85-oak-dr-ep-for-wikiseealso-with-additive-renee-embedding.ipynb 3
import os,torch, torch.multiprocessing as mp, pickle
from xcai.basics import *
from xcai.models.oak import OAK001
from xclib.utils.sparse import retain_topk

# %% ../nbs/85-oak-dr-ep-for-wikiseealso-with-additive-renee-embedding.ipynb 5
os.environ['CUDA_VISIBLE_DEVICES'] = '0,1'
os.environ['WANDB_PROJECT']='xc-nlg_83-oak-dr-ep-for-wikiseealso'

# %% ../nbs/85-oak-dr-ep-for-wikiseealso-with-additive-renee-embedding.ipynb 7
pkl_dir = '/home/scai/phd/aiz218323/scratch/datasets/'
pkl_file = f'{pkl_dir}/processed/wikiseealso_data-metas_distilbert-base-uncased_rm_radga-cat-linker.pkl'

# %% ../nbs/85-oak-dr-ep-for-wikiseealso-with-additive-renee-embedding.ipynb 9
with open(pkl_file, 'rb') as file: block = pickle.load(file)

# %% ../nbs/85-oak-dr-ep-for-wikiseealso-with-additive-renee-embedding.ipynb 10
