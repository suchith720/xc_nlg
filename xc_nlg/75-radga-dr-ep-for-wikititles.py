# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/75-radga-dr-ep-for-wikititles.ipynb.

# %% auto 0
__all__ = ['data_dir', 'pkl_file', 'args', 'metric', 'bsz', 'model', 'learn']

# %% ../nbs/75-radga-dr-ep-for-wikititles.ipynb 3
import os,torch, torch.multiprocessing as mp, pickle
from xcai.basics import *
from xcai.analysis import *
from xcai.models.radgaX import RAD002

# %% ../nbs/75-radga-dr-ep-for-wikititles.ipynb 5
os.environ['CUDA_VISIBLE_DEVICES'] = '0,1'
os.environ['WANDB_PROJECT']='xc-nlg_66-radga-dr-ep-for-wikiseealso'

# %% ../nbs/75-radga-dr-ep-for-wikititles.ipynb 10
...
# %% ../nbs/75-radga-dr-ep-for-wikititles.ipynb 14
with open(pkl_file, 'rb') as file: block = pickle.load(file)

# %% ../nbs/75-radga-dr-ep-for-wikititles.ipynb 16
...
# %% ../nbs/75-radga-dr-ep-for-wikititles.ipynb 17
metric = PrecRecl(block.n_lbl, block.test.data_lbl_filterer, prop=block.train.dset.data.data_lbl,
                  pk=10, rk=200, rep_pk=[1, 3, 5, 10], rep_rk=[10, 100, 200])

# %% ../nbs/75-radga-dr-ep-for-wikititles.ipynb 18
...
# %% ../nbs/75-radga-dr-ep-for-wikititles.ipynb 19
learn = XCLearner(
    model=model, 
    args=args,
...
# %% ../nbs/75-radga-dr-ep-for-wikititles.ipynb 23
if __name__ == '__main__':
    mp.freeze_support()
    learn.train()

# %% ../nbs/75-radga-dr-ep-for-wikititles.ipynb 36
args = XCLearningArguments(
