# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/81-distillation-for-wikiseealso-with-radga.ipynb.

# %% auto 0
__all__ = ['pkl_dir', 'pkl_file', 'args', 'model_output', 'm_teacher', 'm_student', 'model', 'metric', 'learn']

# %% ../nbs/81-distillation-for-wikiseealso-with-radga.ipynb 2
import os,torch, torch.multiprocessing as mp, pickle, numpy as np
from transformers import DistilBertConfig

from xcai.basics import *
from xcai.models.radga import RAD006
from xcai.models.distillation import DTL003,TCH001

from xclib.utils.sparse import retain_topk

# %% ../nbs/81-distillation-for-wikiseealso-with-radga.ipynb 4
os.environ['CUDA_VISIBLE_DEVICES'] = '0,1'
os.environ['WANDB_PROJECT']='xc-nlg_66-radga-dr-ep-for-wikiseealso-2'

# %% ../nbs/81-distillation-for-wikiseealso-with-radga.ipynb 6
pkl_dir = '/home/scai/phd/aiz218323/scratch/datasets/'
pkl_file = f'{pkl_dir}/processed/wikiseealso_data-metas_distilbert-base-uncased_rm_radga-cat-linker.pkl'

# %% ../nbs/81-distillation-for-wikiseealso-with-radga.ipynb 7
with open(pkl_file, 'rb') as file: block = pickle.load(file)

# %% ../nbs/81-distillation-for-wikiseealso-with-radga.ipynb 9
args = XCLearningArguments(
    output_dir='/home/scai/phd/aiz218323/scratch/outputs/81-distillation-for-wikiseealso-with-radga-1-0',
...
# %% ../nbs/81-distillation-for-wikiseealso-with-radga.ipynb 10
...
# %% ../nbs/81-distillation-for-wikiseealso-with-radga.ipynb 11
...
# %% ../nbs/81-distillation-for-wikiseealso-with-radga.ipynb 13
model = DTL003(DistilBertConfig(), m_student=m_student, m_teacher=m_teacher, bsz=bsz, tn_targ=5000, margin=0.3, tau=0.1,
...
# %% ../nbs/81-distillation-for-wikiseealso-with-radga.ipynb 14
metric = PrecRecl(block.n_lbl, block.test.data_lbl_filterer, prop=block.train.dset.data.data_lbl,
                  pk=10, rk=200, rep_pk=[1, 3, 5, 10], rep_rk=[10, 100, 200])

# %% ../nbs/81-distillation-for-wikiseealso-with-radga.ipynb 15
learn = XCLearner(
    model=model,
    args=args,
...
# %% ../nbs/81-distillation-for-wikiseealso-with-radga.ipynb 19
