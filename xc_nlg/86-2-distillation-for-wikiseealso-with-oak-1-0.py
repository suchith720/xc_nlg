# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/86-2-distillation-for-wikiseealso-with-oak.ipynb.

# %% auto 0
__all__ = ['pkl_dir', 'pkl_file', 'args', 'model_output', 'm_teacher', 'bsz', 'm_student', 'meta_embed_file', 'output_dir',
           'mname', 'model', 'metric', 'learn', 'o']

# %% ../nbs/86-2-distillation-for-wikiseealso-with-oak.ipynb 2
...
# %% ../nbs/86-2-distillation-for-wikiseealso-with-oak.ipynb 4
os.environ['WANDB_MODE'] = 'disabled'
os.environ['CUDA_VISIBLE_DEVICES'] = '0,1'
os.environ['WANDB_PROJECT']='xc-nlg_83-oak-dr-ep-for-wikiseealso'

# %% ../nbs/86-2-distillation-for-wikiseealso-with-oak.ipynb 6
pkl_dir = '/home/scai/phd/aiz218323/scratch/datasets/'
pkl_file = f'{pkl_dir}/processed/wikiseealsotitles_data-lnk_distilbert-base-uncased_xcs.pkl'

# %% ../nbs/86-2-distillation-for-wikiseealso-with-oak.ipynb 8
with open(pkl_file, 'rb') as file: block = pickle.load(file)

# %% ../nbs/86-2-distillation-for-wikiseealso-with-oak.ipynb 10
...
# %% ../nbs/86-2-distillation-for-wikiseealso-with-oak.ipynb 11
...
# %% ../nbs/86-2-distillation-for-wikiseealso-with-oak.ipynb 12
model_output = '/home/scai/phd/aiz218323/scratch/outputs/67-ngame-ep-for-wikiseealso-with-input-concatenation-1-4'
...
# %% ../nbs/86-2-distillation-for-wikiseealso-with-oak.ipynb 13
...
# %% ../nbs/86-2-distillation-for-wikiseealso-with-oak.ipynb 15
output_dir = f"/home/scai/phd/aiz218323/scratch/outputs/{os.path.basename(args.output_dir)}"
mname = f'{output_dir}/{os.path.basename(get_best_model(output_dir))}'

# %% ../nbs/86-2-distillation-for-wikiseealso-with-oak.ipynb 16
...
# %% ../nbs/86-2-distillation-for-wikiseealso-with-oak.ipynb 17
metric = PrecRecl(block.n_lbl, block.test.data_lbl_filterer, prop=block.train.dset.data.data_lbl,
                  pk=10, rk=200, rep_pk=[1, 3, 5, 10], rep_rk=[10, 100, 200])

# %% ../nbs/86-2-distillation-for-wikiseealso-with-oak.ipynb 18
learn = XCLearner(
    model=model, 
    args=args,
...
# %% ../nbs/86-2-distillation-for-wikiseealso-with-oak.ipynb 20
o = learn.predict(block.test.dset)

# %% ../nbs/86-2-distillation-for-wikiseealso-with-oak.ipynb 21
