# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/46-encoder-parallel-ramen-clover-with-input-concatenation-for-wikiseealso.ipynb.

# %% auto 0
__all__ = ['data_dir', 'pkl_dir', 'block', 'args', 'test_dset', 'metric', 'bsz', 'model', 'trie', 'learn']

# %% ../nbs/46-encoder-parallel-ramen-clover-with-input-concatenation-for-wikiseealso.ipynb 3
import os,torch, torch.multiprocessing as mp, pickle
from xcai.basics import *
from xcai.models.PPP0XX import DBT017

# %% ../nbs/46-encoder-parallel-ramen-clover-with-input-concatenation-for-wikiseealso.ipynb 5
...
# %% ../nbs/46-encoder-parallel-ramen-clover-with-input-concatenation-for-wikiseealso.ipynb 6
data_dir = '/home/aiscuser/scratch/datasets'

# %% ../nbs/46-encoder-parallel-ramen-clover-with-input-concatenation-for-wikiseealso.ipynb 8
pkl_dir = f'{data_dir}/processed/'

# %% ../nbs/46-encoder-parallel-ramen-clover-with-input-concatenation-for-wikiseealso.ipynb 10
with open(f'{pkl_dir}/wikiseealso_data-metas_distilbert-base-uncased_rm_ramen-cat-encoder-parallel.pkl', 'rb') as file: 
    block = pickle.load(file)

# %% ../nbs/46-encoder-parallel-ramen-clover-with-input-concatenation-for-wikiseealso.ipynb 11
...
# %% ../nbs/46-encoder-parallel-ramen-clover-with-input-concatenation-for-wikiseealso.ipynb 12
...
# %% ../nbs/46-encoder-parallel-ramen-clover-with-input-concatenation-for-wikiseealso.ipynb 13
test_dset = block.test.dset.sample(n=2000, seed=50)
metric = PrecRecl(block.n_lbl, test_dset.data.data_lbl_filterer, prop=block.train.dset.data.data_lbl,
                  pk=10, rk=200, rep_pk=[1, 3, 5, 10], rep_rk=[10, 100, 200])

# %% ../nbs/46-encoder-parallel-ramen-clover-with-input-concatenation-for-wikiseealso.ipynb 14
...
# %% ../nbs/46-encoder-parallel-ramen-clover-with-input-concatenation-for-wikiseealso.ipynb 15
trie = XCTrie.from_block(block)

# %% ../nbs/46-encoder-parallel-ramen-clover-with-input-concatenation-for-wikiseealso.ipynb 16
learn = XCLearner(
    model=model, 
    args=args,
    trie=trie,
...
# %% ../nbs/46-encoder-parallel-ramen-clover-with-input-concatenation-for-wikiseealso.ipynb 20
