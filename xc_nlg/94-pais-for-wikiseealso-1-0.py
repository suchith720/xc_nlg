# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/94-pais-for-wikiseealso.ipynb.

# %% auto 0
__all__ = ['pkl_dir', 'pkl_file', 'args', 'model_output', 'm_teacher', 'bsz', 'model', 'meta_embed_file', 'metric', 'learn']

# %% ../nbs/94-pais-for-wikiseealso.ipynb 2
...
# %% ../nbs/94-pais-for-wikiseealso.ipynb 11
...
# %% ../nbs/94-pais-for-wikiseealso.ipynb 13
...
# %% ../nbs/94-pais-for-wikiseealso.ipynb 15
metric = PrecRecl(block.n_lbl, block.test.data_lbl_filterer, prop=block.train.dset.data.data_lbl,
                  pk=10, rk=200, rep_pk=[1, 3, 5, 10], rep_rk=[10, 100, 200])

# %% ../nbs/94-pais-for-wikiseealso.ipynb 16
learn = XCLearner(
    model=model, 
    args=args,
...
# %% ../nbs/94-pais-for-wikiseealso.ipynb 20
