...
args = XCLearningArguments(
    output_dir='/home/aiscuser/outputs/20-nar-training-pipeline-for-distilbert-2-2',
...
model = DBT007.from_pretrained('distilbert-base-uncased', tn_targ=10_000, ig_tok=0, reduction='sum')
