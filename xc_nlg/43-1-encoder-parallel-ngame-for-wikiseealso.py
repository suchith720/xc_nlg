# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/43-1-encoder-parallel-ngame-for-wikiseealso.ipynb.

# %% auto 0
__all__ = ['data_dir', 'pkl_file', 'args', 'output_dir', 'mname', 'bsz', 'model', 'test_dset', 'metric', 'learn', 'pred_dir']

# %% ../nbs/43-1-encoder-parallel-ngame-for-wikiseealso.ipynb 3
import os,torch, torch.multiprocessing as mp, pickle
from scipy import sparse
from xcai.basics import *
from xcai.models.PPP0XX import DBT009

# %% ../nbs/43-1-encoder-parallel-ngame-for-wikiseealso.ipynb 4
os.environ['WANDB_MODE'] = 'disabled'
os.environ['CUDA_VISIBLE_DEVICES'] = '12,13'

# %% ../nbs/43-1-encoder-parallel-ngame-for-wikiseealso.ipynb 6
...
# %% ../nbs/43-1-encoder-parallel-ngame-for-wikiseealso.ipynb 7
...
# %% ../nbs/43-1-encoder-parallel-ngame-for-wikiseealso.ipynb 8
output_dir = f"/home/aiscuser/scratch/Projects/xc_nlg/outputs/{os.path.basename(args.output_dir)}"
mname = f'{output_dir}/{os.path.basename(get_best_model(output_dir))}'

# %% ../nbs/43-1-encoder-parallel-ngame-for-wikiseealso.ipynb 9
...
# %% ../nbs/43-1-encoder-parallel-ngame-for-wikiseealso.ipynb 10
...
# %% ../nbs/43-1-encoder-parallel-ngame-for-wikiseealso.ipynb 11
