...
args = XCLearningArguments(
    output_dir='/home/scai/phd/aiz218323/scratch/outputs/63-ramen-ep-for-wikiseealso-2-1',
...
model = DBT021.from_pretrained('sentence-transformers/msmarco-distilbert-base-v4', tn_targ=1000, margin=0.3, tau=0.1, apply_softmax=True, n_negatives=10,
                           m_lw=[0.5,0.5], meta_prefix='cat', use_encoder_parallel=True, task_repr_type='tok', meta_repr_type='cls')
model.init_dr_head()
