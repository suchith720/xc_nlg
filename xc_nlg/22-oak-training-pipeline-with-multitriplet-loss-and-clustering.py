...
# %% ../nbs/22-oak-training-pipeline-with-multitriplet-loss-and-clustering.ipynb 17
learn = XCLearner(
    model=model, 
    args=args,
    trie=trie,
...
# %% ../nbs/22-oak-training-pipeline-with-multitriplet-loss-and-clustering.ipynb 22
