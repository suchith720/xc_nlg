# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/97-distillation-for-wikititles-with-oak.ipynb.

# %% auto 0
__all__ = ['pkl_dir', 'pkl_file', 'args', 'model_output', 'm_teacher', 'bsz', 'm_student', 'meta_embed_file', 'model', 'metric',
           'learn']

# %% ../nbs/97-distillation-for-wikititles-with-oak.ipynb 2
...
# %% ../nbs/97-distillation-for-wikititles-with-oak.ipynb 4
os.environ['CUDA_VISIBLE_DEVICES'] = '0,1'
os.environ['WANDB_PROJECT']='xc-nlg_97-oak-dr-ep-for-wikititles'

# %% ../nbs/97-distillation-for-wikititles-with-oak.ipynb 12
pkl_dir = '/home/scai/phd/aiz218323/scratch/datasets/'
pkl_file = f'{pkl_dir}/processed/wikititles_data-metas_distilbert-base-uncased_rm_oak-linker.pkl'

# %% ../nbs/97-distillation-for-wikititles-with-oak.ipynb 14
with open(pkl_file, 'rb') as file: block = pickle.load(file)

# %% ../nbs/97-distillation-for-wikititles-with-oak.ipynb 16
args = XCLearningArguments(
    output_dir='/home/scai/phd/aiz218323/scratch/outputs/97-distillation-for-wikititles-with-oak-1-0',
...
# %% ../nbs/97-distillation-for-wikititles-with-oak.ipynb 17
...
# %% ../nbs/97-distillation-for-wikititles-with-oak.ipynb 18
...
# %% ../nbs/97-distillation-for-wikititles-with-oak.ipynb 20
...
# %% ../nbs/97-distillation-for-wikititles-with-oak.ipynb 21
metric = PrecRecl(block.n_lbl, block.test.data_lbl_filterer, prop=block.train.dset.data.data_lbl,
                  pk=10, rk=200, rep_pk=[1, 3, 5, 10], rep_rk=[10, 100, 200])

# %% ../nbs/97-distillation-for-wikititles-with-oak.ipynb 22
learn = XCLearner(
    model=model, 
    args=args,
...
# %% ../nbs/97-distillation-for-wikititles-with-oak.ipynb 24
