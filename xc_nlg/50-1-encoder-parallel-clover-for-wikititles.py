# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/50-1-encoder-parallel-clover-for-wikititles.ipynb.

# %% auto 0
__all__ = ['data_dir', 'pkl_file', 'args', 'output_dir', 'mname', 'bsz', 'model', 'trie', 'train_dset', 'metric', 'learn',
           'pred_dir', 'test_dset']

# %% ../nbs/50-1-encoder-parallel-clover-for-wikititles.ipynb 3
import os,torch, torch.multiprocessing as mp, pickle
from scipy import sparse
from xcai.basics import *
from xcai.models.PPP0XX import DBT013

# %% ../nbs/50-1-encoder-parallel-clover-for-wikititles.ipynb 5
os.environ['WANDB_MODE'] = 'disabled'

# %% ../nbs/50-1-encoder-parallel-clover-for-wikititles.ipynb 6
os.environ['CUDA_VISIBLE_DEVICES'] = '0,1'
os.environ['WANDB_PROJECT']='xc-nlg_35-oak-training-pipeline-with-multitriplet-loss-and-clustering-for-wikititles'

# %% ../nbs/50-1-encoder-parallel-clover-for-wikititles.ipynb 8
...
# %% ../nbs/50-1-encoder-parallel-clover-for-wikititles.ipynb 9
...
# %% ../nbs/50-1-encoder-parallel-clover-for-wikititles.ipynb 10
output_dir = f"/home/aiscuser/scratch/Projects/xc_nlg/outputs/{os.path.basename(args.output_dir)}"
mname = f'{output_dir}/{os.path.basename(get_best_model(output_dir))}'

# %% ../nbs/50-1-encoder-parallel-clover-for-wikititles.ipynb 11
...
# %% ../nbs/50-1-encoder-parallel-clover-for-wikititles.ipynb 12
trie = XCTrie.from_block(block)

# %% ../nbs/50-1-encoder-parallel-clover-for-wikititles.ipynb 14
...
# %% ../nbs/50-1-encoder-parallel-clover-for-wikititles.ipynb 20
pred_dir = f'{mname}/predictions/'
os.makedirs(pred_dir, exist_ok=True)
