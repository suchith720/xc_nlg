...
# %% ../nbs/25-ramen-style-clover-training-with-input-augmentation.ipynb 4
...
# %% ../nbs/25-ramen-style-clover-training-with-input-augmentation.ipynb 8
...
args = XCLearningArguments(
    output_dir='/home/aiscuser/outputs/25-ramen-style-clover-training-with-input-augmentation-2-1',
    ...
    fp16=True,
    label_names=['pcat2lbl_idx', 'pcat2lbl_lbl2ptr', 'cat2lbl_idx', 'cat2lbl_input_ids', 
                 'cat2lbl_attention_mask', 'cat2lbl_lbl2ptr',
                 'pcat2data_idx', 'pcat2data_data2ptr', 'cat2data_idx', 'cat2data_input_ids', 
                 'cat2data_attention_mask', 'cat2data_data2ptr',
                ],
    
)

# %% ../nbs/25-ramen-style-clover-training-with-input-augmentation.ipynb 17
...
model = DBT017.from_pretrained('distilbert-base-uncased', ig_tok=0, bsz=bsz, tn_targ=10_000, margin=0.3, tau=0.1, 
                               n_negatives=5, apply_softmax=True, lw=100.0, m_lw=0.3, meta_prefix='cat', 
                               init_drh=True)

# %% ../nbs/25-ramen-style-clover-training-with-input-augmentation.ipynb 20
trie = XCTrie.from_block(block)

# %% ../nbs/25-ramen-style-clover-training-with-input-augmentation.ipynb 21
learn = XCLearner(
    model=model, 
    args=args,
    trie=trie,
...
# %% ../nbs/25-ramen-style-clover-training-with-input-augmentation.ipynb 24
