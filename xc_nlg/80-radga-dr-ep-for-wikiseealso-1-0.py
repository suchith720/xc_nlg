# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/80-radga-dr-ep-for-wikiseealso.ipynb.

# %% auto 0
__all__ = ['pkl_dir', 'pkl_file', 'data_meta', 'args', 'metric', 'bsz', 'model', 'learn']

# %% ../nbs/80-radga-dr-ep-for-wikiseealso.ipynb 3
import os,torch, torch.multiprocessing as mp, pickle
from xcai.basics import *
from xcai.models.radga import RAD006
from xclib.utils.sparse import retain_topk

# %% ../nbs/80-radga-dr-ep-for-wikiseealso.ipynb 8
os.environ['CUDA_VISIBLE_DEVICES'] = '0,1'
os.environ['WANDB_PROJECT']='xc-nlg_66-radga-dr-ep-for-wikiseealso-2'

# %% ../nbs/80-radga-dr-ep-for-wikiseealso.ipynb 10
pkl_dir = '/home/scai/phd/aiz218323/scratch/datasets/'
pkl_file = f'{pkl_dir}/processed/wikiseealso_data-metas_distilbert-base-uncased_rm_radga-cat-linker.pkl'

# %% ../nbs/80-radga-dr-ep-for-wikiseealso.ipynb 12
with open(pkl_file, 'rb') as file: block_cat = pickle.load(file)

# %% ../nbs/80-radga-dr-ep-for-wikiseealso.ipynb 14
...
# %% ../nbs/80-radga-dr-ep-for-wikiseealso.ipynb 17
...
# %% ../nbs/80-radga-dr-ep-for-wikiseealso.ipynb 18
metric = PrecRecl(block.n_lbl, block.test.data_lbl_filterer, prop=block.train.dset.data.data_lbl,
                  pk=10, rk=200, rep_pk=[1, 3, 5, 10], rep_rk=[10, 100, 200])

# %% ../nbs/80-radga-dr-ep-for-wikiseealso.ipynb 20
...
# %% ../nbs/80-radga-dr-ep-for-wikiseealso.ipynb 22
learn = XCLearner(
    model=model, 
    args=args,
...
# %% ../nbs/80-radga-dr-ep-for-wikiseealso.ipynb 25
