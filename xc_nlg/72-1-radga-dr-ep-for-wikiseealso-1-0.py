...
# %% auto 0
__all__ = ['pkl_dir', 'pkl_file', 'args', 'metric', 'output_dir', 'mname', 'bsz', 'model', 'learn', 'o']
...
# %% ../nbs/72-1-radga-dr-ep-for-wikiseealso.ipynb 8
...
# %% ../nbs/72-1-radga-dr-ep-for-wikiseealso.ipynb 17
learn = XCLearner(
    model=model, 
    args=args,
