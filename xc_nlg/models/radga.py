...
# %% auto 0
__all__ = ['PARAM', 'wikiseealso', 'wikititles', 'Fuser', 'DBT018', 'DBT019']
...
# %% ../../nbs/37-radga-model-architecture.ipynb 8
PARAM = {
    'info_column_names': ['identifier', 'input_text'],
    'smp_features': [('lbl2data',1,4), ('hlk2data',1,4), ('hlk2lbl2data',2,4)],
    'use_tokenizer': True,
...
# %% ../../nbs/37-radga-model-architecture.ipynb 9
...
# %% ../../nbs/37-radga-model-architecture.ipynb 10
...
# %% ../../nbs/37-radga-model-architecture.ipynb 11
CFGS['wikiseealso'] = wikiseealso
CFGS['wikititles'] = wikititles

# %% ../../nbs/37-radga-model-architecture.ipynb 13
from xcai.data import XCDataset
from fastcore.utils import *
from fastcore.meta import *

@patch
def _verify_inputs(self:XCDataset):
...
# %% ../../nbs/37-radga-model-architecture.ipynb 24
import torch
...
# %% ../../nbs/37-radga-model-architecture.ipynb 25
class Fuser(nn.Module):
    ...
    def forward(
        ...
        q_m, k_m = q_m.view(bs, 1, -1, 1).float(), k_m.view(bs, 1, 1, -1).float()
        ...
        o = data + self.o(unshape(torch.matmul(w, v))) # (bs, q_len, dim)
        o = self.layer_norm(o)
...
# %% ../../nbs/37-radga-model-architecture.ipynb 27
from xcai.models.MMM0XX import Pooling, XCModelOutput

# %% ../../nbs/37-radga-model-architecture.ipynb 28
class DBT018(DBT013):
...
# %% ../../nbs/37-radga-model-architecture.ipynb 29
class DBT019(DBT018):
