...
args = XCLearningArguments(
    output_dir='/home/scai/phd/aiz218323/scratch/outputs/62-clover-ep-for-wikiseealso-with-clr-for-dr-1-0',
...
model = DBT014.from_pretrained('distilbert-base-uncased', ig_tok=0, bsz=bsz, tn_targ=1000, margin=0.3,
                               tau=0.1, n_negatives=10, apply_softmax=True, lw=0.1, tie_word_embeddings=False)
model.init_dr_head()
...
# %% ../nbs/62-clover-ep-for-wikiseealso-with-clr-for-dr.ipynb 21
