...
block = XCBlock.from_cfg('/home/aiscuser/scratch/datasets', 'data', valid_pct=0.001, tfm='xcnlg', 
                         tokenizer='sentence-transformers/msmarco-distilbert-base-v4', smp_features=[('lbl2data',1,1)])

# %% ../nbs/19-ngame-training-pipeline-with-multitriplet-loss-with-clustering.ipynb 9
args = XCLearningArguments(
    output_dir='/home/aiscuser/outputs/19-ngame-training-pipeline-with-multitriplet-loss-with-clustering-2-21',
...
# %% ../nbs/19-ngame-training-pipeline-with-multitriplet-loss-with-clustering.ipynb 15
learn = XCLearner(
    model=model, 
    args=args,
...
# %% ../nbs/19-ngame-training-pipeline-with-multitriplet-loss-with-clustering.ipynb 18
