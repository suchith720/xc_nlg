...
block = XCBlock.from_cfg('/home/aiscuser/scratch/datasets', 'data_meta', valid_pct=0.001, 
                         ...
                         smp_features=[('lbl2data',1,2), ('hlk2data',1,3)], n_data_meta_samples=5)
...
model = DBT018.from_pretrained('distilbert-base-uncased', ig_tok=0, bsz=bsz, tn_targ=5000, tn_meta=5000, 
                               margin=0.3, tau=0.1, n_negatives=5, apply_softmax=True, lw=0.01,
                               aug_meta_prefix='hlk', init_drh=False)
