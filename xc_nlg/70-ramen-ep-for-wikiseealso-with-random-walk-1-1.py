...
args = XCLearningArguments(
    output_dir='/home/scai/phd/aiz218323/scratch/outputs/70-ramen-ep-for-wikiseealso-with-random-walk-1-1',
    ...
    max_grad_norm=None,
    fp16=True,
    label_names=['lco2lbl2data_idx', 'lco2lbl2data_input_ids', 'lco2lbl2data_attention_mask'],
...
model = DBT021.from_pretrained('sentence-transformers/msmarco-distilbert-base-v4', bsz=bsz, tn_targ=5000, margin=0.3, tau=0.1,
                               apply_softmax=True, n_negatives=10, m_lw=0.15, meta_prefix='lco', use_encoder_parallel=True,
