...
args = XCLearningArguments(
    output_dir='/home/aiscuser/outputs/22-oak-training-pipeline-with-multitriplet-loss-and-clustering-2-0',
...
model = DBT013.from_pretrained('sentence-transformers/msmarco-distilbert-base-v4', ig_tok=0, bsz=bsz, 
