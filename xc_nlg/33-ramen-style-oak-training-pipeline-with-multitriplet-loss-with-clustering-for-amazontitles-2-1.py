...
args = XCLearningArguments(
    output_dir='/home/aiscuser/outputs/33-ramen-style-oak-training-pipeline-with-multitriplet-loss-with-clustering-for-amazontitles-2-1',
...
model = DBT014.from_pretrained('distilbert-base-uncased', ig_tok=0, bsz=bsz, tn_targ=1000, margin=0.3, tau=0.1, 
                               n_negatives=5, apply_softmax=True, lw=0.001, m_lw=0.05, meta_prefix='rel', 
                               init_drh=True)
