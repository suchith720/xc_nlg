# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/51-1-encoder-parallel-ramen-clover-for-wikititles.ipynb.

# %% auto 0
__all__ = ['data_dir', 'pkl_file', 'args', 'output_dir', 'mname', 'bsz', 'model', 'trie', 'train_dset', 'metric', 'learn',
           'pred_dir', 'test_dset']

# %% ../nbs/51-1-encoder-parallel-ramen-clover-for-wikititles.ipynb 3
import os,torch, torch.multiprocessing as mp, pickle
from scipy import sparse
from xcai.basics import *
from xcai.models.PPP0XX import DBT017

# %% ../nbs/51-1-encoder-parallel-ramen-clover-for-wikititles.ipynb 5
os.environ['WANDB_MODE'] = 'disabled'

# %% ../nbs/51-1-encoder-parallel-ramen-clover-for-wikititles.ipynb 6
...
# %% ../nbs/51-1-encoder-parallel-ramen-clover-for-wikititles.ipynb 9
...
# %% ../nbs/51-1-encoder-parallel-ramen-clover-for-wikititles.ipynb 10
...
# %% ../nbs/51-1-encoder-parallel-ramen-clover-for-wikititles.ipynb 11
output_dir = f"/home/aiscuser/scratch/Projects/xc_nlg/outputs/{os.path.basename(args.output_dir)}"
mname = f'{output_dir}/{os.path.basename(get_best_model(output_dir))}'

# %% ../nbs/51-1-encoder-parallel-ramen-clover-for-wikititles.ipynb 12
...
# %% ../nbs/51-1-encoder-parallel-ramen-clover-for-wikititles.ipynb 13
trie = XCTrie.from_block(block)

# %% ../nbs/51-1-encoder-parallel-ramen-clover-for-wikititles.ipynb 14
...
# %% ../nbs/51-1-encoder-parallel-ramen-clover-for-wikititles.ipynb 15
pred_dir = f'{mname}/predictions/'
os.makedirs(pred_dir, exist_ok=True)
with open(f'{pred_dir}/train_predictions.pkl', 'wb') as file: pickle.dump(train_pred, file)

# %% ../nbs/51-1-encoder-parallel-ramen-clover-for-wikititles.ipynb 18
...
# %% ../nbs/51-1-encoder-parallel-ramen-clover-for-wikititles.ipynb 20
pred_dir = f'{mname}/predictions/'
os.makedirs(pred_dir, exist_ok=True)
