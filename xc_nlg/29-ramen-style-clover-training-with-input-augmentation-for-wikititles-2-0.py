# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/29-ramen-style-clover-training-with-input-augmentation-for-wikititles.ipynb.

# %% auto 0
__all__ = ['block', 'args', 'test_dset', 'metric', 'bsz', 'model', 'trie', 'learn']

# %% ../nbs/29-ramen-style-clover-training-with-input-augmentation-for-wikititles.ipynb 4
...
# %% ../nbs/29-ramen-style-clover-training-with-input-augmentation-for-wikititles.ipynb 6
os.environ['CUDA_VISIBLE_DEVICES'] = '6,7'
os.environ['WANDB_PROJECT']='xc-nlg_29-ramen-style-clover-training-with-input-augmentation-for-wikititles'

# %% ../nbs/29-ramen-style-clover-training-with-input-augmentation-for-wikititles.ipynb 8
...
# %% ../nbs/29-ramen-style-clover-training-with-input-augmentation-for-wikititles.ipynb 10
block = AugmentMetaInputIdsTfm.apply(block, 'hlk_meta', 32, True)

# %% ../nbs/29-ramen-style-clover-training-with-input-augmentation-for-wikititles.ipynb 11
...
# %% ../nbs/29-ramen-style-clover-training-with-input-augmentation-for-wikititles.ipynb 12
...
# %% ../nbs/29-ramen-style-clover-training-with-input-augmentation-for-wikititles.ipynb 15
test_dset = block.test.dset.sample(n=2000, seed=50)
metric = PrecRecl(block.n_lbl, test_dset.data.data_lbl_filterer, prop=block.train.dset.data.data_lbl,
                  pk=10, rk=200, rep_pk=[1, 3, 5, 10], rep_rk=[10, 100, 200])

# %% ../nbs/29-ramen-style-clover-training-with-input-augmentation-for-wikititles.ipynb 16
...
# %% ../nbs/29-ramen-style-clover-training-with-input-augmentation-for-wikititles.ipynb 18
trie = XCTrie.from_block(block)

# %% ../nbs/29-ramen-style-clover-training-with-input-augmentation-for-wikititles.ipynb 19
learn = XCLearner(
    model=model, 
    args=args,
    trie=trie,
...
# %% ../nbs/29-ramen-style-clover-training-with-input-augmentation-for-wikititles.ipynb 22
