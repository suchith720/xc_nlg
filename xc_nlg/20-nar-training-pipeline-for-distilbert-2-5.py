...
# %% ../nbs/20-nar-training-pipeline-for-distilbert.ipynb 21
tok_idf = get_tok_idf(block.train.dset, field='lbl2data_input_ids', n_cols=30522)

# %% ../nbs/20-nar-training-pipeline-for-distilbert.ipynb 24
args = XCLearningArguments(
    output_dir='/home/aiscuser/outputs/20-nar-training-pipeline-for-distilbert-2-5',
...
# %% ../nbs/20-nar-training-pipeline-for-distilbert.ipynb 25
test_dset = block.test.dset.sample(n=2000, seed=50)
metric = PrecRecl(block.n_lbl, test_dset.data.data_lbl_filterer, prop=block.train.dset.data.data_lbl,
                  pk=10, rk=200, rep_pk=[1, 3, 5, 10], rep_rk=[10, 100, 200])

# %% ../nbs/20-nar-training-pipeline-for-distilbert.ipynb 26
model = DBT007.from_pretrained('distilbert-base-uncased', tn_targ=10_000, ig_tok=0, vocab_weights=tok_idf,
                               reduction='mean')

# %% ../nbs/20-nar-training-pipeline-for-distilbert.ipynb 28
trie = XCTrie.from_block(block)

# %% ../nbs/20-nar-training-pipeline-for-distilbert.ipynb 29
learn = XCLearner(
    model=model, 
    args=args,
    trie=trie,
...
# %% ../nbs/20-nar-training-pipeline-for-distilbert.ipynb 30
learn.train()
