# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/69-distillation-for-wikiseealso.ipynb.

# %% auto 0
__all__ = ['pkl_dir', 'pkl_file', 'args', 'bsz', 'model_output', 'output_dir', 'mname', 'm_teacher', 'model_weight_file',
           'model_weights', 'm_student', 'metric', 'model', 'learn']
...
# %% ../nbs/69-distillation-for-wikiseealso.ipynb 4
os.environ['CUDA_VISIBLE_DEVICES'] = '0,1'
os.environ['WANDB_PROJECT']='xc-nlg_69-distillation-for-wikiseealso'

# %% ../nbs/69-distillation-for-wikiseealso.ipynb 5
